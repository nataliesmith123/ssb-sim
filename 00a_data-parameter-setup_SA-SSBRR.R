...
# SENSITIVITY ANALYSIS - SSB on diabetes RR
  # this RR is from the SR and was within the 11 US studies ONLY, so not a guarantee that they did NOT adjust for BMI
  ssbOnDiabRR_input = 1.11
  ssbOnDiabRRLL_input = 1.10 
  ssbOnDiabRRUL_input = 1.21
